...
export function minimumEnclosingDisc(points) {
...
export function enclosingDiscRadius(points) {
    return minimumEnclosingDisc(points).radius;
}
//# sourceMappingURL=enclosing_disc.js.map